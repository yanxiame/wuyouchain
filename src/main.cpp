...
int64 nChainStartTime = 1504249868; // 2017/9/1 15:11:8
...
const string strMessageMagic = "WUYOUCHAIN Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in WUYOUCHAIN
    bool fStrictPayToScriptHash = true; // Always active in WUYOUCHAIN
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WUYOUCHAIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017-9-4 WUYOUCHAIN vector empty mapBlockIndex WUYOUCHAIN ....";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 502580 : 502580;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
        block.print();
        assert(block.hashMerkleRoot == uint256("0x86ba2015999939c178cc66bc1642a24c0dfe0025118b21251ec9f951237ab57d"));
...
unsigned char pchMessageStart[4] = { 0xa7, 0xc3, 0xa7, 0xa2 };
