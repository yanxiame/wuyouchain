...
{
    resize(850, 550);
    setWindowTitle(tr("WUYOUCHAIN") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a WUYOUCHAIN address"));
   ...
   // aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About WUYOUCHAIN"), this);
   // aboutAction->setToolTip(tr("Show information about WUYOUCHAIN"));
   // aboutAction->setMenuRole(QAction::AboutRole);
   // aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
   // aboutQtAction->setToolTip(tr("Show information about Qt"));
   // aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for WUYOUCHAIN"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt Wallet..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    addNodeAction=new QAction(QIcon(":/icons/add_node"),tr("&Add Node"),this);
   ...
   // connect(aboutAction, SIGNAL(triggered()), this, SLOT(aboutClicked()));
    ...
    connect(addNodeAction,SIGNAL(triggered(bool)),this,SLOT(addNode()));
}
...
void BitcoinGUI::createMenuBar()
{
    ...
    settings->addAction(addNodeAction);
    settings->addSeparator();
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("WUYOUCHAIN client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("WUYOUCHAIN client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WUYOUCHAIN network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid WUYOUCHAIN address or malformed URI parameters."));
    }
...
//添加节点-打开WUYOUCHAIN配置文件 07/26/2106 csl
void BitcoinGUI::addNode(){

    boost::filesystem::path pathConfigure = GetConfigFile();

    /* Open WUYOUCHAIN.conf with the associated application */
    if (boost::filesystem::exists(pathConfigure))
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(string_To_UTF8(pathConfigure.string()))));
}
